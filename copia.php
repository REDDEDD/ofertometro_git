				...
				<nav class="navbar navbar-expand-lg auto" style="padding-bottom:0px!important;padding-top:0px!important;">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent">
				    ...
				    <form class="form-inline my-2 my-lg-0 mr-auto">
				      ...
				      <button style="border-radius: 0px 8px 8px 0px;margin-left:-8px" class="btn btn-danger my-2 my-sm-0" type="submit">Buscar</button>
				    </form>
				    <ul class="navbar-nav margin-left-auto">
					    ...
					    <li class="nav-item">
					    	<a class="nav-link" href="#"><button type="button" class="btn btn-danger" style="margin-left:-10%">Log in</button></a>
					    </li>
					</ul>
				  </div>
				</nav>
